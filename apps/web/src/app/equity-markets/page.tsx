          ...
          <Box as="tbody">
            {equityCoverage.map((market, index) => (
              <Box as="tr" key={market.slug}>
                <Box
                  as="td"
                  borderBottomWidth={index === equityCoverage.length - 1 ? "0" : "1px"}
                  borderColor="edge"
                  px={{ base: "5", md: "6" }}
                  py={{ base: "4", md: "5" }}
                >
                  <Link asChild color="text" fontWeight="semibold" textDecoration="none" _hover={{ color: "accent", textDecoration: "none" }}>
